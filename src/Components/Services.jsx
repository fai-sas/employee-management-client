          ...
          <div className='py-8 transition-all shadow-md mb-9 rounded-xl px-7 hover:shadow-lg sm:p-9 lg:px-6 xl:px-9'>
            ...
            <div>
              ...
              <p className='text-base font-medium leading-relaxed text-body-color'>
                Start for free! Explore streamlined HR, efficient workforce
                management, and enhanced employee engagement, all without any
                initial cost. Unlock seamless employee management today.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className='w-full px-4 md:w-1/2 lg:w-1/3'>
          <div className='py-8 transition-all shadow-md mb-9 rounded-xl px-7 hover:shadow-lg sm:p-9 lg:px-6 xl:px-9'>
            ...
            <div>
              ...
              <p className='text-base font-medium leading-relaxed text-body-color'>
                Enhance employee development and performance with our
                performance management tools. Set goals, conduct evaluations,
        ...
        <div className='w-full px-4 md:w-1/2 lg:w-1/3'>
          <div className='py-8 transition-all shadow-md mb-9 rounded-xl px-7 hover:shadow-lg sm:p-9 lg:px-6 xl:px-9'>
            ...
            <div>
              ...
              <p className='text-base font-medium leading-relaxed text-body-color'>
                Boost collaboration and project efficiency with our task and
                project management features. Assign tasks, track progress, and
                ensure timely completion of projects for a more productive
                workforce
              </p>
            </div>
          </div>
        ...
        <div className='w-full px-4 md:w-1/2 lg:w-1/3'>
          <div className='py-8 transition-all shadow-md mb-9 rounded-xl px-7 hover:shadow-lg sm:p-9 lg:px-6 xl:px-9'>
            ...
            <div>
              ...
              <p className='text-base font-medium leading-relaxed text-body-color'>
                Effortlessly integrate new team members with our seamless
                onboarding process. Reduce paperwork, automate documentation,
                and ensure a smooth transition for every employee.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className='w-full px-4 md:w-1/2 lg:w-1/3'>
          <div className='py-8 transition-all shadow-md mb-9 rounded-xl px-7 hover:shadow-lg sm:p-9 lg:px-6 xl:px-9'>
            ...
            <div>
              ...
              <p className='text-base font-medium leading-relaxed text-body-color'>
                Enjoy spam free and encrypted communication channels. Your data
                is protected, ensuring a safe and confidential employee
        ...
        <div className='w-full px-4 md:w-1/2 lg:w-1/3'>
          <div className='py-8 transition-all shadow-md mb-9 rounded-xl px-7 hover:shadow-lg sm:p-9 lg:px-6 xl:px-9'>
            ...
            <div>
              ...
              <p className='text-base font-medium leading-relaxed text-body-color'>
                Optimize workforce productivity with our robust time and
                attendance tracking system. Easily monitor employee hours,
                manage schedules, and generate accurate payroll reports.
              </p>
            </div>
          </div>
        </div>
