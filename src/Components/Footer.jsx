...
const Footer = () => {
  return (
    <footer className='w-full py-16 bg-gray-100 dark:bg-gray-900'>
      <div className='md:px-12 lg:px-28'>
        <div className='container m-auto space-y-6 text-gray-600 dark:text-gray-300'>
          ...
          <div className='flex items-center justify-between m-auto space-x-4 w-max'>
          ...
          <div className='text-center'>
            <span className='text-sm tracking-wide'>
              Copyright © Jobsy <span id='year'>2023</span> | All right reserved
            </span>
          </div>
        </div>
      </div>
